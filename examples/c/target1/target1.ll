...
@c = dso_local global double -5.689000e+00, align 8
@.str = private unnamed_addr constant [6 x i8] c"TEST!\00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"TEST%n\0A\00", align 1
...
6:                                                ; preds = %0
  ...
  %9 = call i32 (i8*, ...) @printf(i8* noundef %8)
...
12:                                               ; preds = %6, %0
  %13 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i32* noundef %3)
  ret i32 0
}
